...
<div class="wrap">
    ...
    <div id="user-guide-page">
        <h1>How do I...</h1>
        <p>Select your topic of interest to expand.</p>
        ...
        <ol>
            <li>Select the <em>Create Ride Sheets</em> option under the <em>Rider Mileage</em> submenu.</li>
        ...
        <h3 style="cursor: pointer">consolidate obsolete rides in the mileage database?</h3>
        <div class="initially-hidden">
        <p></p>
        <ol>
            <li>Select the <em>Database Ops</em> option under the <em>Rider Mileage</em> submenu.</li>
