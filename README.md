...
1. Login to the _pwtc.com_ website.
1. Navigate to the administrator menus page. 
1. Select the _Create Ride Sheets_ option under the _Rider Mileage_ submenu.
1. A page displays that shows a table of all the posted rides that are without ride sheets.
1. Find the appropriate ride based on the rider signup sheet's name and date.
1. Select the _Create_ link in the _Action_ column of the ride's table row.
1. Select _OK_ when the confirmation dialog pops up.
1. A page displays that is the ride sheet leader and mileage entry form.
1. more...

### amend a rider's mileage for a ride in the mileage database?

1. Login to the _pwtc.com_ website.
1. Navigate to the administrator menus page. 
1. Select the _Manage Ride Sheets_ option under the _Rider Mileage_ submenu.
1. A page displays that shows a search form for existing ride sheets.
1. Select the _From Date_ field and choose the ride's date from the popup calendar.
1. A table displays that shows all the existing ride sheets for that day.
1. Find the appropriate ride sheet based on the information given by the rider.
1. Select the _Edit_ link in the _Action_ column of the ride sheet's table row.
1. A page displays that is the ride sheet leader and mileage entry form.
1. more...
